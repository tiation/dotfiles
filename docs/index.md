---
layout: default
title: Dotfiles - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Dotfiles</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/dotfiles" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
# Run container
docker run -p 8080:8080 dotfiles
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/dotfiles)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/dotfiles/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/dotfiles/discussions)
